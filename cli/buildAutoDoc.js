...
const options = [
   ...
   new Option(
      '--noKaizenLoad',
      'Не выполнять загрузку дерева участков Кайдзен. С этой опцией также отключается проверка существования участков Кайдзен.'
   )
      .default(false),
   new Option(
      '--force',
   ...
   new Option(
      '--packageManager <name>',
      'Использовать определенный пакетный менеджер для установки зависимостей.'
   )
      .default('npm')
      .choices(['npm', 'yarn'])
];
