...
class Config {
   ...
   _buildPaths(modules) {
      ...
      for (const module of modules) {
         ...
         if (module.name === 'PixiReact') {
            this._buildPathsForPixiReact(module);
            continue;
         }
   ...
   _buildPathsForPixiReact(module) {
      this.options.compilerOptions.paths['pixi-react'] = ['./' + pathUtils.join(pathUtils.relative(this.root, module.path), '6.8.0', 'types.d.ts')];
   }
}
