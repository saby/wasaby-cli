...
class Builder {
   ...
   async _buildModulesListForConfig() {
      ...
      for (const module of this.modules.getModules()) {
         ...
         if (module.featuresProvided && module.featuresProvided.length !== 0) {
   ...
   injectFeaturesProvidedModules(modules) {
      ...
      for (const {module, builderConfigModule} of modules.values()) {
         if (this.requiredFeature.includes(module.id)) {
            ...
            detectedFeature = [...detectedFeature, ...module.featuresProvided.map(currentFeature => currentFeature.name)];
      ...
      for (const {module, builderConfigModule} of addableModules) {
         ...
         if (!detectedFeature.includes(module.featuresProvided[0].name) || this.isDependence(module)) {
            this.buildModules.push(module);
         }
      }
