...
class ModuleManager {
    ...
    static async getDepsList(version, modules) {
        ...
        count++;
        await logger.writeFile(`getDepsList_Responce_BL_${count}.json`, JSON.stringify(data, null, 3));
    ...
    static async getDependedModules(version, modules, repositories) {
        ...
        count++;
        await logger.writeFile(`getDependedModules_Responce_BL_${count}.json`, JSON.stringify(data, null, 3));
