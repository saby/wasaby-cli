...
describe('Builder', () => {
   ...
   describe('_buildModulesListForConfig()', () => {
      ...
      test('should build modules list with module has themes files', async() => {
         const module = {
            ...moduleInfo,
            name: 'Module-theme',
            path: 'src/Module-theme'
         };
         builder.modules.add(Module.buildModuleFromObject(module));
         builder.metaInfo.add(Module.buildModuleFromObject({
            ...module,
            revision: 'rev2'
         }));
         ...
         expectModulesConfig(builder.config.modules[0], {
            name: 'Module-theme',
            path: 'src/Module-theme',
            changedFiles: ['./theme.json', './_new_theme.less', "./theme.less"],
            deletedFiles: []
         });
      });
