    ...
    describe('redirectTestPath(root, args, modules)', () => {
        describe('win32', () => {
            ...
            test('should replace file path and extension', () => {
                ...
                expect(args.testPathPatterns).toEqual('F:/app/Second/dir/file.test.js');
            });
            ...
            test('should not replace file path and extension', () => {
                ...
                expect(args.runTestsByPath).toBeUndefined();
                expect(args.testPathPatterns).toEqual('D:/repository/Fourth/dir/file.test.tsx');
            });
        });
        describe('posix', () => {
            ...
            test('should replace file path and extension', () => {
                ...
                expect(args.runTestsByPath).toBeUndefined();
                expect(args.testPathPatterns).toEqual('/home/user/app/Second/dir/file.test.js');
            });
            ...
            test('should not replace file path and extension', () => {
                ...
                expect(args.runTestsByPath).toBeUndefined();
                expect(args.testPathPatterns).toEqual('/home/user/repository/Fourth/dir/file.test.tsx');
            });
        });
    });
});
