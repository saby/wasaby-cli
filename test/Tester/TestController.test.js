...
describe('TestController', () => {
   ...
   describe('getExecutors()', () => {
      ...
      test('should return executors only from NodeJS', () => {
         ...
         const tester = new TestController('build/application', new Set([module1, module2, ...JSDOMModules]), buildOptions());
   ...
   describe('runUnitTest()', () => {
      ...
      beforeEach(() => {
         ...
         stubRunTests = jest.spyOn(tester, 'runTests').mockReturnValue(Promise.resolve());
      });
      ...
      test('should detect executors and start tests', async() => {
         ...
         expect(stubOutputFileSync.mock.calls.length).toStrictEqual(2);
      });
   });
});
