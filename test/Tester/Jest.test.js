...
function prepareToCheckConfig(jestConfig) {
   ...
   jestConfig.projects.forEach((project) => {
      ...
      project.moduleNameMapper['.css.json$'] = removeNodeModules(project.moduleNameMapper['.css.json$']);
      project.moduleNameMapper['.css.json.js$'] = removeNodeModules(project.moduleNameMapper['.css.json.js$']);
   ...
   jestConfig.reporters = jestConfig.reporters.map((reporter) => {
      if (!Array.isArray(reporter)) {
         return removeNodeModules(reporter);
      }
